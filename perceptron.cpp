...
Percptron::set_weights(vector<float> w){
    weights = w;
};

Percptron::train(vector<Point> points, float learning_rate=1, int iteration_limit=100){
    /*
